...
export const packages: ServicePackage[] = [
  ...
  {
    id: "digital-solution-blueprint",
    name: "Digital Solution Blueprint",
    summary: "Para organizaciones que aún no saben exactamente qué construir: diseñamos la solución.",
    accent: "cyan",
    icon: "PenTool",
    deliverables: [
      "Problema y proceso",
  ...
  {
    id: "assurance-launch-review",
    name: "Assurance & Launch Review",
    summary: "Revisión previa a publicación: seguridad, calidad, accesibilidad, rendimiento y operación.",
    accent: "violet",
    icon: "ShieldCheck",
    deliverables: [
      "Seguridad",
  ...
  {
    id: "digital-evolution-partnership",
    name: "Digital Evolution Partnership",
    summary: "Acompañamiento continuo: mejorar, mantener, integrar, medir y evolucionar.",
    accent: "mint",
    icon: "Activity",
    deliverables: [
      "Mejoras",
  ...
  {
    id: "technology-orchestration-advisory",
    name: "Technology Orchestration Advisory",
    summary: "Conecta proceso, aplicaciones, datos, cloud, seguridad y operación como un solo sistema.",
    accent: "electric",
    icon: "Workflow",
    deliverables: [
      "Proceso",
